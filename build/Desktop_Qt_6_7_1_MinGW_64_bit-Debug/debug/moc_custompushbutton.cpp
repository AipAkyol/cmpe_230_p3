...
constexpr auto qt_meta_stringdata_CLASSCustomPushButtonENDCLASS = QtMocHelpers::stringData(
    "CustomPushButton",
    "rightClicked",
    ""
);
...
void CustomPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CustomPushButton::*)();
            if (_t _q_method = &CustomPushButton::rightClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomPushButton::rightClicked()
{
